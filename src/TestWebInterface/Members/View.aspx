<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="ViewMember" %>
    ...
    <div class="form">
        ...
        <div class="fields">
            <div>
             ...
             --><span class="col2">
                    <asp:TextBox ID="textBoxMemberNumber" runat="server" ReadOnly="true" />
                </span>
            </div>
            <div>
                <asp:Label ID="labelMemberType" runat="server" AssociatedControlID="dropDownMemberType" CssClass="col1">Member Type:</asp:Label><!--
             --><span class="col2">
                    <asp:DropDownList ID="dropDownMemberType" runat="server" DataTextField="Value" DataValueField="Key" Enabled="False" />
                </span>
            </div>
            <div>
             ...
             --><span class="col2">
                    <asp:DropDownList ID="dropDownMemberStatus" runat="server" DataTextField="Value" DataValueField="Key" Enabled="False" />
                </span>
            </div>
            <div>
             ...
             --><span class="col2">
                    <asp:TextBox ID="textBoxEffectiveDate" runat="server" ReadOnly="true" />
                </span>
            </div>
            <div>
             ...
             --><span class="col2">
                    <asp:DropDownList ID="dropDownMemberStanding" runat="server" DataTextField="Value" DataValueField="Key" Enabled="False" />
                </span>
            </div>
        </div>
        <div class="buttons">
