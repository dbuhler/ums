<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="AddMember" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="phContent" Runat="Server">
    <h1>Add Member</h1>
    <div class="form" id="formAdd" runat="server">
        <div class="fields">
            <div>
        ...
        <div class="buttons">
            <asp:Button ID="buttonSubmit" Text="Add Record" runat="server" OnClick="buttonSubmit_Click" />
